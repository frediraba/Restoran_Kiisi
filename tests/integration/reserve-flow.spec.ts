...
test.describe("Reservation flow", () => {
  test("shows nearest slot when requested time unavailable", async ({ page }) => {
    ...
    await page.getByTestId("requestedTime-date").fill("2025-10-04");
    await page.getByTestId("requestedTime-time").fill("21:00");
  ...
  test("guest can confirm reservation", async ({ page }) => {
    ...
    await page.getByTestId("requestedTime-date").fill("2025-10-04");
    await page.getByTestId("requestedTime-time").fill("18:30");
